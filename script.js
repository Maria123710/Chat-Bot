...
const API_KEY = 'AIzaSyD5g6V4L9WQTpPF4Cpk5UeJA_MariapAxrX0TLk'; // Add your API key here as a string, e.g. 'AIzaSy...'
const API_URL = `https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=${API_KEY}`;

//MariaAIzaSyD5gMaria6V4L9WQTpP
//F4Cpk5UeJA_MariapAxrX0TLkMaria
...
`;
  ...
  setTimeout(() => {
    const botMsgHTML = `<img src="aiBot.png" alt="" class="avater"><p class="message-text">Just a sec...</p>`;
